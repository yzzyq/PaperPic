...
##    fig,ax = plt.subplots()
    ...
    rects1 = ax.bar(x - width, three_precise[:,0], width, label='2000', zorder=1,facecolor = color_set[0],linewidth=1, linestyle = '--', edgecolor = 'black')
    rects2 = ax.bar(x, three_precise[:,1], width, label='16000', zorder=1, facecolor = color_set[1], edgecolor = 'white')
    rects3 = ax.bar(x + width, three_precise[:,2], width, label='20000', zorder=1, facecolor = color_set[2],linewidth=1, linestyle = '-', edgecolor = 'black')
    ...
    # plt.xticks(x_data)
    ax.set_xticklabels(('0','DJ-Cluster', 'K-Means', 'hierCluster', 'DBSCAN', 'FDCC'),fontsize=13)
    ...
    labels = ['数据量:','2000', '16000', '20000']
    linestyles = ['-','--','-','-']
    edgecolors = ['none','black','none','black']
    color_set = ['none','gray','black','white']
